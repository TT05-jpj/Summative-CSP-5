...
scanBtn.addEventListener('click', async () => {
    ...
    scanPhoto.src = 'data:image/jpeg;base64,' + base64;
...
saveBtn.addEventListener('click', () => {
    ...
    if (scanPhoto.classList.contains('show') && scanPhoto.src) {
        const photos = JSON.parse(localStorage.getItem('scanner-photos') || '{}');
        photos[name.toLowerCase()] = scanPhoto.src;
